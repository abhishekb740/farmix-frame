...
app.frame('/', async (c) => {
  ...
  return c.res({
    ...
    intents: [
      ...
      <Button.Link href='https://farmix.online/'>Website</Button.Link>,
      <Button.Link href="https://warpcast.com/~/compose?text=%F0%9F%8C%90%20Find%20Your%20Digital%20Twin%20on%20Warpcast!%20%F0%9F%9A%80%0A%0AThis%20frame%20allows%20users%20to%20discover%20their%20digital%20twins%20on%20Warpcast%20by%20comparing%20your%20digital%20assets,%20mutual%20connections%20and%20mutual%20channels.%20With%20a%20unique%20similarity%20score%20feature,%20users%20can%20find%20out%20how%20alike%20they%20are%20with%20others%20in%20the%20community.%20%0A%0AWant%20to%20find%20your%20own%20digital%20twin%20and%20see%20how%20similar%20you%20are%20with%20someone?%20Join%20Farmix%20now%20and%20explore%20the%20exciting%20world%20of%20digital%20assets!%0A%0ACheckout%20the%20Detailed%20Analysis%20here:%20https%3A%2F%2Ffarmix.online%2F%0A%0Ahttps%3A%2F%2Ffarmix-frame.vercel.app%2Fapi%2F%20">Share</Button.Link>
    ],
  })
})
...
app.frame("/loading", async (c) => {
  ...
  return c.res({
    ...
    intents: [
      ...
      <Button action='/tipCreator'>Tip</Button>,
      <Button.Redirect location='https://farmix.online/'>Website</Button.Redirect>,
    ]
  })
})
